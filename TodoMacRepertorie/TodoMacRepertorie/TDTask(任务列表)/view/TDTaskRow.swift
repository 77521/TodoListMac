...
//            .padding(.vertical, 8)
//        }
//        .background(selectedTask?.taskId == task.taskId ? themeManager.selectedBackgroundColor : themeManager.backgroundColor)
//        .overlay(
//            // 选中状态指示器
//            RoundedRectangle(cornerRadius: 4)
//                .stroke(selectedTask?.taskId == task.taskId ? Color.accentColor : Color.clear, lineWidth: 2)
//        )
//        // 性能优化：固定高度，减少布局计算
//        .frame(minHeight: 44)
...
//    
//    /// 是否显示子任务
//    private var shouldShowSubTasks: Bool {
//        guard let subTasksStr = task.standbyStr2, !subTasksStr.isEmpty else { return false }
//        return !task.subTaskList.isEmpty
//    }
//    
//    /// 评估指示线视图
//    @ViewBuilder
//    private var assessmentIndicatorView: some View {
//        if let color = assessmentColor {
//            RoundedRectangle(cornerRadius: 1, style: .continuous)
//                .fill(color)
//                .frame(width: 2)
//                .padding(.leading, isDayTodoMode ? -7.8 : -15.8)
//                .padding(.vertical, 5)
//        } else {
//            Color.clear
//                .frame(width: 2)
...
//    /// 任务信息行
//    @ViewBuilder
//    private var taskInfoRow: some View {
//        HStack(spacing: 13) {
//            TDTaskRowComponents.DateView(timestamp: task.todoTime)
//            TDTaskRowComponents.ReminderView(timestamp: task.reminderTime)
//            
