...
//    /// UserDefaults 存储 key
//    private let categoriesKey = "td_local_categories"
//    
//    /// 服务器返回的分类数据
//    private(set) var categories: [TDSliderBarModel] = []
//    
//    private init() {
//        // 初始化时从本地加载数据
...
//    
//    /// 更新本地缓存的分类数据
//    func updateCategories(_ newCategories: [TDSliderBarModel]) {
//        self.categories = newCategories
//        // 保存到本地
//        saveCategoriesLocal(<#[TDSliderBarModel]#>)
//    }
//    
//    /// 获取本地缓存的分类数据
//    func getCategories() -> [TDSliderBarModel] {
//        return categories
//    }
//    
//    /// 清除本地分类数据（退出登录时调用）
...
//    }
//    /// 从本地加载分类数据
//    private func loadCategoriesFromLocal() -> [TDSliderBarModel] {
//        do {
//            let data = try Data(contentsOf: categoriesFileURL)
//            let categories = try JSONDecoder().decode([TDSliderBarModel].self, from: data)
//            return categories
...
//    
//    /// 保存分类数据到本地
//    private func saveCategoriesLocal(_ categories: [TDSliderBarModel]) async {
//        await withCheckedContinuation { continuation in
//            Task.detached {
//                do {
//                    let data = try JSONEncoder().encode(categories)
